...
def plot_pic(x_value, y_value, title, x_name):
    plt.plot(x_value, y_value[0], 'r', label='Kulc')  # use pylab to plot x and y
    plt.plot(x_value, y_value[1], 'g', label='IR')  # use pylab to plot x and y
